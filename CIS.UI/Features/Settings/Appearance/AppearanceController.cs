...
{
    private AppearanceConfiguration _originalAppearance = new();
    ...
    private void Initiaize()
    {
        ...
        [
            ...
            new Link { DisplayName = "Custom", Source = new Uri("/Assets/Themes/CustomTheme.xaml", UriKind.Relative) },
        ];

        // 9 accent colors from metro design principles
        //this.ViewModel.AccentColors =
        //[
        ...
        {
            FontSize = this.ViewModel.SelectedFontSize,
            Theme = new() { Value = this.ViewModel.SelectedTheme },
            Color = new() { Value = this.ViewModel.SelectedAccentColor }
        };
    }
