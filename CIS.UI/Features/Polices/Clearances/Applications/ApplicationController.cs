...
public class ApplicationController : ControllerBase<ApplicationViewModel>
{
    ...
    private ClearanceIdCardReportViewModel GenerateClearance()
    {
        ...
        using (var transaction = session.BeginTransaction())
        {
            ...
            var clearanceAlias = default(Clearance);
            var applicantAlias = default(Applicant);
    ...
    private void PrintClearance(ClearanceIdCardReportViewModel data)
    {
        ...
        report.ReportEmbeddedResource = "CIS.UI.Features.Polices.Clearances.Applications.ClearanceReport.rdlc";
