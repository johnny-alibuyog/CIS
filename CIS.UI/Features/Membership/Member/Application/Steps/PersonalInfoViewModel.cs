...
public class PersonalInfoViewModel : WizardStep
{
    public override string Title { get; set; } = typeof(PersonalInfoViewModel).Name.SplitToWords();
    ...
    public static PersonalInfoViewModel Create() => new();
}
