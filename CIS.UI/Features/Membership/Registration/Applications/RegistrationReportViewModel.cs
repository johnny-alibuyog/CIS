...
public class RegistrationReportViewModel : ViewModelBase
{
    ...
    public override object SerializeWith(object instance)
    {
        ...
        if (instance is RegistrationReportViewModel)
        {
            var target = this;
            var source = instance as RegistrationReportViewModel;
    ...
    public static RegistrationReportViewModel GetTestData()
    {
        var result = new RegistrationReportViewModel();
        ...
        using (var transaction = session.BeginTransaction())
        {
            ...
            //var pictureAlias = default(ImageBlob);
