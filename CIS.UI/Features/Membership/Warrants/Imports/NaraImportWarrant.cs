...
namespace CIS.UI.Features.Membership.Warrants.Imports
{
    public class NaraImportWarrant
    {
        ...
        public static NaraImportWarrant OfDataRow(DataRow row)
        {
            return new()
            {
                WarrantCode = row.Field<string>("WarrantCode"),
                CaseNumber = row.Field<string>("CaseNumber"),
                Crime = row.Field<string>("Crime"),
                Remarks = row.Field<string>("Remarks"),
                BailAmount = row.Field<decimal>("BailAmount"),
                IssuedOn = row.Field<string>("IssuedOn").ParseDate(),
                IssuedBy = row.Field<string>("IssuedBy"),
                IssuedAtAddress1 = row.Field<string>("IssuedAtAddress1"),
                IssuedAtAddress2 = row.Field<string>("IssuedAtAddress2"),
                IssuedAtBarangay = row.Field<string>("IssuedAtBarangay"),
                IssuedAtCity = row.Field<string>("IssuedAtCity"),
                IssuedAtProvince = row.Field<string>("IssuedAtProvince"),
            };
        }
    }
}
